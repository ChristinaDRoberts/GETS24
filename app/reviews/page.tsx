...
import StephanieIcon from '../../public/review-icons/stephanie-review.png';
...
export default function page() {
  ...
  const imageData = [
    ...
    {
      icon: StephanieIcon,
      text: 'Guardian Emergency Tree Service promptly came out to take down 3 trees for me. After they arrived, I decided to take down a 4th tree and it was no problem.  They are kind, courteous, and know their job! Thanks!',
